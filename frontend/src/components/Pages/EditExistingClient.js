...
const EditExistingClient = () => {
    ...
    const handleSaveDraft = async (e) => {
       ...
       const handleSubmit = async (e) => {
        // const row = location.state.selectedRow[0]._id; // Access the first item in the array
        //console.log(location.state.selectedRow[0]._id);
         const normalizedRow = Array.isArray(location.state.selectedRow)
         ? location.state.selectedRow
         : [location.state.selectedRow];
            ...
            try {
                e.preventDefault(); // prevents refreshing and losing data
                    ...
                    if(!prevDraftStatus){
                        ...
                        console.log("this record is no longer in the draft box!");
                    }
